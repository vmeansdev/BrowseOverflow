...
- (void)testForInitialEmptyQuestionList{
    XCTAssertEqual([[topic recentQuestions] count], (NSUInteger)0,
...
- (void)testAddingAQuestionToTheList{
    ...
    XCTAssertEqual([[topic recentQuestions] count], (NSUInteger)1,
...
- (void)testQuestionsAreListedChronologically{
    ...
    Question *listedLast = questions[1];
    
    XCTAssertEqualObjects([listedFirst.date laterDate:listedLast.date], listedFirst.date,
...
- (void)testLimitOfTwentyQuestions{
    ...
    XCTAssertTrue([[topic recentQuestions] count] < 21,
                  @"There should never be more than 20 questions");
}
